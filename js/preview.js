...
<ul>
<li><span></span>
<p>KERENDIA (finerenone) 10mg, 20mg, 40mg tablets is indicated to reduce the risk of cardiovascular death, hospitalization for heart failure, and urgent heart failure visits in adult patients with heart failure with left ventricular ejection fraction (HF LVEF) ≥40%
</p>
</li>
</ul>
...
<ul>
<li><span></span>
<p>Hypersensitivity to any component of this product</p>
</li>
<li><span></span>
<p>Concomitant use with strong CYP3A4 inhibitors</p>
</li>
<li><span></span>
<p>Patients with adrenal insufficiency </p>
</li>
</ul>
<h1>WARNINGS AND PRECAUTIONS:</h1>
<ul>
<li><span></span>
<p><span class="bold-italic">Hyperkalemia:</span> KERENDIA can cause hyperkalemia. The risk for developing hyperkalemia increases with decreasing kidney function and is greater in patients with higher baseline potassium levels or other risk factors for hyperkalemia. Measure serum potassium and estimated glomerular filtration rate (eGFR) in all patients before initiation of treatment with KERENDIA and dose accordingly. Do not initiate KERENDIA if serum potassium is <span style="display: inline-block">&gt;5 mEq/L</span>
</p>
</li>
</ul>
